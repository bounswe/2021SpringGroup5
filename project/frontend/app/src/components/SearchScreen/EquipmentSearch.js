...
import { equipmentSearchRequest } from '../../services/SearchService';
            ...
            <CardActionArea>
                ...
                <CardContent>
                    ...
                    <div className="row">
                        ...
                        >
                            {new Date(data.created_date).toLocaleTimeString()}<br></br>{new Date(data.created_date).toDateString()}
                        </div>
                    </div>
                </CardContent>
            </CardActionArea>
...
function SearchScreen(props) {
    ...
    const handleSearchRequest = async () => {
        try {
            const response = await equipmentSearchRequest({
