...
class MainEventScreen extends StatefulWidget {
  ...
  const MainEventScreen({Key? key, this.willFetchAllEvents = false})
      : super(key: key);
...
class _MainEventScreenState extends State<MainEventScreen> {
  ...
  Future fetchEvents() async {
    ...
    var params = {
      "status": "upcoming",
      "search_query": "",
      "sort_func": {"isSortedByLocation": false},
      "filter_func": {
        "location": null,
        "sportType": "",
        "date": null,
  ...
  showAlertDialog(BuildContext context, todayflag, thisweekflag, thismonthflag,
      alltimeflag, opentoapplicationflag, fullflag, cancelledflag, mapCallback,
      {sportType = ""}) async {
    ...
    var params = {
      "status": "upcoming",
      "search_query": "",
      "sort_func": {"isSortedByLocation": true},
      "filter_func": {
        "location": {
          "lat": mapCallback[0],
          "lng": mapCallback[1],
